        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div style="margin-right: 10%; float:right;">
                    <a href="{{url('add_au')}}" class="btn btn-outline-success">Add new</a>
                </div>
                    ...
                    <tbody>
                        @foreach ($data as $row )
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('edit_au/'. $row->authorID)}}" class="btn btn-success">
                                    <span class="fa fa-edit text-primary"></span>Edit</a>
                                    <a href="{{url('delete_au/'. $row->authorID)}}" class="btn btn-danger"
