    ...
    <div class="" id="product">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <br><div style="margin-right: 5%; float:right;">
                    <a href="{{url('add')}}" class="btn btn-outline-success">Create New Product</a>
                </div></br>               
                    ...
                    <tbody>
                        @foreach ($data as $row )
                            <tr>
                                ...
                                <td>
                                    <a href =""><img src="images/{{$row->img}}" style="height: 110px; width:95px" title="{{$row->description}}"></a>
                                </td>
                                <td>{{$row->price}}</td>
                                <td>
                                    <a class="btn btn-success" href="{{url('edit/'. $row->productID)}}">
                                    <span class="fa fa-edit text-primary"></span> Edit</a>
                                    <a class="dropdown-item delete_data" href="{{url('delete/'. $row->productID)}}"  
